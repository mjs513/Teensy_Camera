...
public:
  ...
  // size_t cb2=0); void readFrameMultiBufferFlexIO(void* buffer1, size_t size1,
  // void* buffer2, size_t size2); bool startReadFlexIO(bool (*callback)(void
  // *frame_buffer), void *fb1, size_t cb1, void *fb2, size_t cb2); bool
  // stopReadFlexIO();
