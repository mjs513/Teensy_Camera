...
public:
  ...
  virtual void setPins(uint8_t mclk_pin, uint8_t pclk_pin, uint8_t vsync_pin,
                       ...
                       uint8_t g5 = 0xff, uint8_t g6 = 0xff, uint8_t g7 = 0xff,
                       TwoWire &wire = Wire);
  virtual bool begin(framesize_t framesize = FRAMESIZE_QVGA, int framerate = 30,
                     bool use_gpio = false) = 0;
  virtual void end() = 0;
  virtual int reset() = 0;
  ...
  virtual bool startReadFlexIO(bool (*callback)(void *frame_buffer), void *fb1,
                               size_t cb1, void *fb2, size_t cb2);
  ...
  // desired.
  virtual bool startReadFrameDMA(bool (*callback)(void *frame_buffer) = nullptr,
                                 uint8_t *fb1 = nullptr,
                                 uint8_t *fb2 = nullptr) = 0;
  ...
  // into setFramesize however if you set a zoom window this is the size of that
  // window.
...
protected:
  ...
  static DMASetting
      _dmasettings[10]; // For now lets have enough for two full size buffers...
