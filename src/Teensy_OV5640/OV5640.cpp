...
// BUGBUG::: see where frame is
    ...
    */
    ...
    //     if (_debug)
    //         debug.println("Error: autofocus failed");
    //     return false; // failed to set resolution
    // }
    return true;
}
...
int OV5640::reset() {
    ...
    if (_useAF) {
        ...
        cameraWriteRegister(OV5640_CMD_MAIN, 0x00);
        ...
        while (sensor != AF_STATUS_S_IDLE) {
            cameraReadRegister(0x3029, sensor);
