...
extern int arduino_i2c_read(unsigned short address, unsigned char reg,
                            unsigned char *value);
extern int arduino_i2c_write(unsigned short address, unsigned char reg,
                             unsigned char value);
...
void ov7670_printRegs() { arduino_i2c_printRegs(OV7670_I2C_ADDR >> 1); }
...
static const struct i2c_device_id ov7670_id[] = {
    {"ov7670", MODEL_OV7670}, {"ov7675", MODEL_OV7675}, {}};
